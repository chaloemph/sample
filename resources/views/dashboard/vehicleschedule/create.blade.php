    ...
    <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('dashboard.vehicleschedules.store')}}">
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="time" class="form-control" id="starttime_expected" name="starttime_expected" required>
                                </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <select id="vehiclepoint_id" class="form-control" name="vehiclepoint_id" required>
                                  ...
                                  <option value="{{$vehiclepoint->id}}">{{$vehiclepoint->startpoint }} - {{$vehiclepoint->endpoint }} </option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <select id="vehicle_id" class="form-control" name="vehicle_id" required>
                                  ...
                                  <option value="{{$vehicle->id}}">({{$vehicle->vehicletype->name}}) {{$vehicle->name}} </option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group col-md-6">
                                ...
                                <select id="type" class="form-control" name="type" required>
                                  ...
                                  <option value="{{$type}}">{{($type === 'go')? 'ขาไป':'ขากลับ'}}</option>
                                  @endforeach
                                </select>
                              </div>
                            </div>
