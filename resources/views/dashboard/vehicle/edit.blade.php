    ...
    <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('dashboard.vehicles.update',['vehicle'=> $vehicle->id])}}">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <select id="vehicletype_id" class="form-control" name="vehicletype_id" required>
                                  ...
                                  <option value="{{$vehicletype->id}}" {{($vehicle->vehicletype_id == $vehicletype->id)? 'selected':''}}>{{$vehicletype->name}}</option>
                                  @endforeach
                                </select>
                              </div>
                              <div class="form-group col-md-6">
