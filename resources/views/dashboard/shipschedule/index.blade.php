                            ...
                            <table class="table" width="100%" cellspacing="0">
                                ...
                                <thead>
                                    <tr class="bold">
                                        ...
                                        <th>เวลาออก</th>
                                        {{-- <th>ราคา</th> --}}
                                        <th width="250px" class="text-center">จัดการ</th>
                                    </tr>
                                </thead>
                                <tbody class="" style="font-size: 0.8rem;">
                                    ...
                                    <tr class="align-items-center">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('fullcalendar.fillter',[ 'type_id' => $value->id , 'type' => 'ship' ])}}" target="_blank" class="btn btn-sm btn-secondary"><i class="fas fa-calendar-alt" style="padding: 3px"></i></a>
                                        </td>
                                    </tr>
                                        @endforeach
                                </tbody>
