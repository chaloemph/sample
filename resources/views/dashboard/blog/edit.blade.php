    ...
    <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('dashboard.blogs.update',['blog'=> $blog->id])}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                            ...
                            <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control description" name="description" id="description" cols="30" rows="10">{{$blog->description}}</textarea>
                              </div>
                            </div>

                            <div class="form-row">
                              <div class="form-group col-md-12">
                                <img src="/images/blog/{{$blog->attachfile}}" style="max-width: 250px;" class="img-fluid">
                              </div>
                            </div>
