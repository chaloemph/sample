...
<head>
	...
	<body>
				...
				<td valign="top" colspan="2" style="background: #D0D5F5;">
					<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align="center">
								<div class="logo">
									<img src="/images/logo.png" border="0" width="120" height="120">
								</div>
							</td>
							<td width="1" align="center">
								<h3 class="head-top">Lipeh Ferry & Speed Boat (INVOICE)</h3>
								<h4 class="head-top">509 หมู่ที่ 2 ต.ปากน้ำ อ.ละงู จ.สตูล 91110 โทร.<!--  098-010-2202,  089-464-7816, 094-319-8111 --> 094-319-8111 , 089-464-7816 , 098-010-2202 แฟ็กซ์ 0-7478-3068</h4>
										...
										@if ($booking->tour_type_oneway === 'go')
											...
											<div class="text-content-val transfer-detail">
												...
												วันเดินทางไป  {{ date('d/m/Y',strtotime($booking->checkin_date)) }} 
													:  {{$booking->vehicleschedulego->starttime}} 
												เวลาถึง  {{date('h:i',strtotime($booking->vehicleschedulego->starttime_expected))}} 
											</p>
											</div>
										@else
											<div class="text-content">
											...
											<div class="text-content-val transfer-detail">
												<p class="card-text"> 
												   ...
												   วันเดินทางกลับ {{ date('d/m/Y',strtotime($booking->checkout_date)) }} 
													:  {{date('h:i',strtotime($booking->vehiclescheduleback->starttime))}} 
												   เวลาถึง  {{date('h:i',strtotime($booking->vehiclescheduleback->starttime_expected))}} 
											   </p>
											</div>
										@endif
									@else
						...
						{{-- <tr>
							<td colspan="4">
								<style type="text/css">
										...
										.table-invoice tr td .table-service td{
											text-align: left;
									    min-width: 188px;
									    text-transform: capitalize;
								...
								<div class="text-content" style="display: block;margin-bottom:15px;">
									บริการ
								</div>
								<div class="text-content-val" style="text-align: left;">
						...
						<tr>
							<td align="center" colspan="4">
								...
								<div style="width: 100%;text-align: left;padding-left: 250px;">
									...
									<p> <img src="/images/kbank.png" style="width: 40px;"> กสิกร 035-8-86210-1</p>
									<p> <img src="/images/ktb.png"  style="width: 40px;"> กรุงไทย 901-3-46462-9</p>
									<p><img src="/images/scb.png"  style="width: 40px;"> ไทยพาณิชย์ 864-222-698-9</p>
									<p><img src="/images/GSB.png"  style="width: 40px;"> ออมสิน 020179401334</p>
									<p> <img src="/images/bk.png"  style="width: 40px;"> กรุงเทพ 455-049-583-4</p>
								</div>
							</td>
						</tr>
					</table>
		...
		<p style="text-align:center;margin-top: 40px;">
			<button type="button" class="btn btn-default print-hidden" onclick="window.location='{{route('payment.index')}}';">
				<i class="fas fa-paper-plane"></i> แจ้งชำระเงิน
			</button>
			<button type="button" class="btn btn-primary print-hidden" onclick="window.print();">
				<i class="fa fa-print fa-lg"></i> พิมพ์
			</button>
		</p>
		<div style="height:100px;" class="print-hidden">
			&nbsp;
		</div>
