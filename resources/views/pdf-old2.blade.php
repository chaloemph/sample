										...
										@if ($booking->tour_type_oneway === 'go')
											...
											<div class="text-content-val transfer-detail">
												...
												วันเดินทางไป  {{ date('d/m/Y',strtotime($booking->checkin_date)) }} 
													...
													<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$booking->vehicleschedules_go_detail ." ".$booking->vehicleschedulego->starttime}} 
											...
											<div class="text-content-val transfer-detail">
												<p class="card-text"> 
												   ...
												   วันเดินทางกลับ {{ date('d/m/Y',strtotime($booking->checkout_date)) }} 
													...
													<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{$booking->vehicleschedules_back_detail." ".date('H:i',strtotime($booking->vehiclescheduleback->starttime))}} 
											...
											<td width="50%" valign="top" colspan="2" style="border: none;border-right: 1px #666DA2 solid;">
												...
												<div class="text-content-val transfer-detail">
													<p class="card-text">
													   ...
													   วันเดินทางไป  {{ date('d/m/Y',strtotime($booking->checkin_date)) }} 
														{{-- <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{ ($booking->vehicleschedulego->vehicle->first()->vehicletype_id === 2 )? $booking->vehicleschedules_go_detail:$booking->vehicleschedulego->starttime}}  --}}
														<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  เวลาไป {{ $booking->vehicleschedules_go_detail." ".$booking->vehicleschedulego->starttime}}   ({{$booking->vehicleschedulego->vehiclepoint->first()->startpoint}})
														<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   {{ ($booking->vehicleschedulego->vehicle->first()->vehicletype_id === 2 )? '':"เวลาถึง ".date('H:i',strtotime($booking->vehicleschedulego->starttime_expected))}} 
														 ({{$booking->vehicleschedulego->vehiclepoint->first()->endpoint}})
												   </p>
												</div>
											</td>
											<td width="50%" valign="top" colspan="2" style="border: none;">
												...
												<div class="text-content-val transfer-detail">
													<p class="card-text"> 
													   ...
													   วันเดินทางกลับ {{ date('d/m/Y',strtotime($booking->checkout_date)) }} 
														{{-- <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{ ($booking->vehiclescheduleback->vehicle->first()->vehicletype_id === 2 )? $booking->vehicleschedules_back_detail:date('H:i',strtotime($booking->vehiclescheduleback->starttime))}}  --}}
														<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; เวลาไป {{ $booking->vehicleschedules_back_detail." ".date('H:i',strtotime($booking->vehiclescheduleback->starttime_expected))}}  ({{$booking->vehiclescheduleback->vehiclepoint->first()->endpoint}})
													    <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{ ($booking->vehiclescheduleback->vehicle->first()->vehicletype_id === 2 )? '':"เวลาถึง". date('H:i',strtotime($booking->vehiclescheduleback->starttime))}}  ({{$booking->vehiclescheduleback->vehiclepoint->first()->startpoint}})
												   </p>
												</div>
											</td>
										</tr>
